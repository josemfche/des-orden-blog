      ...
      <div className="hidden sm:block">
        <div className="relative">
          <input
            type="text"
            placeholder="Buscar"
            className="searchInputHome text-gray-400 bg-gray-100 py-2 pl-4 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent"
          />
