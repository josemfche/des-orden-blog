...
const TwoColumnImageAndText = ({ image, title, description, reverse, url, buttonText }) => {
  const content = (
    <div className="mb-6">
      ...
      <div className="w-full md:w-1/2 lg:w-7/12 px-12 text-center">
  ...
  return (
    <div className={`flex flex-wrap lg:px-8 px-2 lg:mx-8 ${reverse ? 'flex-row-reverse' : 'flex-row'} items-center`}>
      {content}
    </div>
  );
};
